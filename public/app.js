const dictionary = {
  zh: {
    ...
    "home.subtitle": "向量跃迁为企业提供 AI 客服报价助手、流媒体内容工具平台与 AI 词库知识库，帮助企业更高效地连接客户、内容与业务场景。",
    "home.ctaPrimary": "预约商务沟通",
    "home.ctaSecondary": "查看产品",
    "home.productsEyebrow": "产品中心",
    "home.productsTitle": "三类 AI 产品，覆盖客服转化、流媒体内容与知识资产",
    ...
    "home.value1": "从客户咨询、内容处理到知识资产沉淀，围绕真实业务流程设计产品。",
    ...
    "home.faq3Answer": "可以先从最影响转化和效率的问题开始判断：咨询和报价多就先看 AI 客服报价助手，视频内容要复用就看流媒体内容工具平台，话术和资料分散就看 AI 词库知识库。",
    ...
    "products.pageIntro": "围绕客户咨询、报价转化、流媒体内容处理和企业知识沉淀，构建可落地、可演示、可扩展的 AI 产品矩阵。",
    "products.fitEyebrow": "先做哪个产品",
    ...
    "products.fitMediaText": "短视频、直播切片和平台素材很多，但下载、转文稿、总结、拆解和复用流程分散，优先考虑流媒体内容工具平台。",
    ...
    "products.media.name": "流媒体内容工具平台",
    "products.media.desc": "面向短视频下载、转文稿、总结、拆解与内容复用的 AI 工作台。",
    "products.media.point1": "视频下载与转文稿",
    "products.media.point2": "视频总结与文案拆解",
    "products.media.point3": "内容库和账号跟踪",
    "products.media.long": "适合希望通过短视频、直播切片、平台素材和内容复用提升增长效率的企业，帮助团队把视频素材处理、文稿提取、总结拆解和内容合成变成流程化能力。",
    "products.media.audience": "企业老板、市场团队、新媒体运营、招商获客团队。",
    "products.media.capability": "视频下载、视频转文稿、视频总结、文案拆解、账号跟踪、内容库与团队协作。",
    "products.media.value": "降低素材处理和内容复盘成本，让企业稳定沉淀可复用的选题、脚本与视频资产。",
    ...
    "products.delivery1Text": "把产品资料、常见问题、销售话术、视频素材和商品规则整理成 AI 可使用的结构。",
    "products.delivery2Title": "首版上线",
    "products.delivery2Text": "围绕一个明确业务入口上线第一版，优先保证可沟通、可演示、可迭代。",
    "products.delivery3Title": "复盘优化",
    "products.delivery3Text": "根据真实客户问题、团队反馈和业务重点继续补充知识、优化话术和内容流程。",
    ...
    "solutions.content.problem": "企业想通过短视频、直播切片和私域内容获客，但素材下载、转文稿、总结拆解和内容库管理分散，导致账号难以持续输出。",
    "solutions.content.point1": "支持视频下载、转文稿和总结，把外部素材快速变成可复盘内容。",
    ...
    "footer.note": "官方网站 vectorleap.xyz · AI products for business growth.",
    "form.sending": "提交中...",
  ...
  en: {
    ...
    "home.subtitle": "Vector Leap provides an AI service and quotation assistant, a streaming media content platform, and an AI lexicon knowledge base to help companies connect customers, content, and business workflows.",
    "home.ctaPrimary": "Book a Consultation",
    "home.ctaSecondary": "Explore Products",
    "home.productsEyebrow": "Products",
    "home.productsTitle": "Three AI product lines for service conversion, media content, and knowledge assets",
    ...
    "home.decision1Text": "We first look at where customers come from: website, WeChat, ads, short video, exhibitions, or sales visits. AI becomes valuable when it connects to real entry points.",
    ...
    "home.value1": "We design around real workflows, from customer inquiries and content processing to knowledge asset reuse.",
    ...
    "home.faq3Answer": "Start with the problem that affects conversion or efficiency most: inquiries and quotes for the AI service assistant, video reuse for the media platform, or scattered scripts and materials for the AI lexicon.",
    ...
    "products.pageIntro": "A deployable and scalable AI product matrix for customer inquiries, quotation conversion, streaming media content processing, and enterprise knowledge assets.",
    "products.fitEyebrow": "Where to Start",
    "products.fitTitle": "Start with the workflow slowing growth most",
    ...
    "products.fitMediaText": "If short videos, live clips, and platform materials are hard to download, transcribe, summarize, analyze, and reuse, start with the streaming media content platform.",
    ...
    "products.media.name": "Streaming Media Content Platform",
    "products.media.desc": "An AI workspace for short video download, transcription, summaries, copy analysis, and content reuse.",
    ...
    "products.media.long": "Built for companies that use short videos, live clips, platform materials, and content reuse to drive growth. It turns video processing, transcription, summaries, copy analysis, and content assembly into a repeatable workflow.",
    "products.media.audience": "Business owners, marketing teams, media operators, and acquisition teams.",
    "products.media.capability": "Video download, video transcription, video summaries, copy analysis, account tracking, content library, and team collaboration.",
    "products.media.value": "Reduce material processing and content review cost, helping teams build reusable topics, scripts, and video assets.",
    ...
    "products.delivery1Text": "Organize product materials, FAQs, sales scripts, video assets, and product rules into AI-ready structures.",
    ...
    "products.delivery3Text": "Use real customer questions, team feedback, and business priorities to improve knowledge, scripts, and content workflows.",
    ...
    "solutions.ctaText": "Tell us about your customer sources, sales workflow, content operations, or knowledge materials. Vector Leap will help you choose the first AI implementation path.",
    ...
    "footer.note": "Official domain vectorleap.xyz · AI products for business growth.",
