const dictionary = {
  zh: {
    ...
    "legal.privacy1Title": "信息收集范围",
    "legal.privacy1Text": "当你提交咨询表单时，我们会收集姓名、公司或个人身份、联系方式、邮箱、感兴趣业务和需求描述。网站也可能记录必要的访问日志，用于安全排查和服务稳定性分析。",
    "legal.privacy2Title": "信息使用方式",
    "legal.privacy2Text": "我们仅将信息用于商务联系、需求判断、方案沟通、服务交付和网站运营改进，不会出售或出租给无关第三方。",
    "legal.privacy3Title": "存储与保护",
    "legal.privacy3Text": "我们会采用合理的技术和管理措施保护信息安全，并尽量限制只有需要处理咨询或交付服务的人员访问相关信息。",
    "legal.privacy4Title": "第三方服务",
    "legal.privacy4Text": "如后续接入邮件、统计、云服务或支付等第三方能力，我们会优先选择具备合规能力的服务商，并仅传递完成服务所需的信息。",
    "legal.privacy5Title": "你的权利",
    "legal.privacy5Text": "你可以通过官网展示的邮箱或电话联系我们，申请查询、更正或删除你提交的信息。我们会在合理时间内处理。",
    "legal.privacy6Title": "政策更新",
    "legal.privacy6Text": "本政策会根据业务和法律要求适时更新，更新后将在本页面展示。",
    "legal.termsEyebrow": "服务条款",
    "legal.termsTitle": "向量跃迁官网服务条款",
    "legal.termsIntro": "访问或使用向量跃迁官网，即表示你理解并同意以下条款。若不同意，请停止使用本网站。",
    "legal.terms1Title": "网站服务说明",
    "legal.terms1Text": "本网站用于展示公司信息、产品服务、解决方案和商务联系入口。页面内容不构成固定报价、最终承诺或法律意见。",
    "legal.terms2Title": "用户责任",
    "legal.terms2Text": "提交咨询时，请确保信息真实、准确、合法，不得上传或发送侵犯他人权益、违法违规或恶意攻击网站的内容。",
    "legal.terms3Title": "知识产权",
    "legal.terms3Text": "网站中的文字、图片、商标、界面设计和产品信息归向量跃迁或相应权利方所有，未经许可不得用于商业复制、改编或再发布。",
    "legal.terms4Title": "免责声明",
    "legal.terms4Text": "我们会尽力保持网站内容准确和可用，但不保证所有信息始终完整、即时或无误。因网络环境、第三方服务或不可抗力导致的访问异常，我们会尽力修复。",
    "legal.terms5Title": "变更与联系",
    "legal.terms5Text": "我们可能根据业务需要调整网站内容和条款。若有疑问，可通过官网展示的邮箱、电话或微信联系我们。",
    "form.sending": "提交中...",
  ...
  en: {
    ...
    "legal.privacy1Title": "Information We Collect",
    "legal.privacy1Text": "When you submit an inquiry form, we collect your name, company or individual identity, contact details, email, interested business, and requirement description. The website may also keep necessary access logs for security and stability.",
    "legal.privacy2Title": "How We Use Information",
    "legal.privacy2Text": "We use information only for business contact, requirement evaluation, solution communication, service delivery, and website improvement. We do not sell or rent it to unrelated third parties.",
    "legal.privacy3Title": "Storage and Protection",
    "legal.privacy3Text": "We use reasonable technical and management measures to protect information and limit access to people who need it for inquiries or service delivery.",
    "legal.privacy4Title": "Third-party Services",
    "legal.privacy4Text": "If email, analytics, cloud, payment, or other third-party capabilities are added later, we will prefer compliant providers and share only the information necessary to complete the service.",
    "legal.privacy5Title": "Your Rights",
    "legal.privacy5Text": "You may contact us through the email or phone shown on the website to request access, correction, or deletion of submitted information. We will respond within a reasonable time.",
    "legal.privacy6Title": "Policy Updates",
    "legal.privacy6Text": "This policy may be updated according to business and legal requirements. Updates will be shown on this page.",
    "legal.termsEyebrow": "Terms of Service",
    "legal.termsTitle": "Vector Leap Website Terms of Service",
    "legal.termsIntro": "By accessing or using the Vector Leap website, you understand and agree to these terms. If you do not agree, please stop using the website.",
    "legal.terms1Title": "Website Service",
    "legal.terms1Text": "This website presents company information, products, solutions, and business contact channels. Page content is not a fixed quotation, final commitment, or legal advice.",
    "legal.terms2Title": "User Responsibility",
    "legal.terms2Text": "When submitting an inquiry, please ensure the information is true, accurate, and lawful. Do not submit content that infringes rights, violates laws, or attacks the website.",
    "legal.terms3Title": "Intellectual Property",
    "legal.terms3Text": "Text, images, trademarks, interface design, and product information on this website belong to Vector Leap or the relevant rights holders and may not be commercially copied, adapted, or republished without permission.",
    "legal.terms4Title": "Disclaimer",
    "legal.terms4Text": "We try to keep website content accurate and available, but do not guarantee that all information is always complete, current, or error-free. We will work to fix access issues caused by network conditions, third-party services, or force majeure.",
    "legal.terms5Title": "Changes and Contact",
    "legal.terms5Text": "We may update website content and terms as business needs change. If you have questions, contact us through the email, phone, or WeChat shown on the website.",
  ...
  return `
    <div class="footer-main">
      ...
      <nav class="footer-col" aria-label="公司">
        ...
        <a href="/about" data-i18n="footer.about">关于我们</a>
      ...
      <div class="footer-col footer-contact">
        ...
        <a href="mailto:wang2797545062@gmail.com" data-i18n="footer.email">邮箱：wang2797545062@gmail.com</a>
        <a href="tel:+8618814485834" data-i18n="footer.phone">电话：188 1448 5834</a>
        <span data-i18n="footer.wechat">微信：kaze005</span>
        <span data-i18n="footer.address">地址：广东省深圳市</span>
      </div>
    </div>
