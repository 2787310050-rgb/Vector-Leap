const dictionary = {
  zh: {
    ...
    "home.subtitle": "向量跃迁为企业提供 AI 客服报价助手、灵感方舟与 AI 词库知识库，帮助企业更高效地连接客户、内容与业务场景。",
    "home.ctaPrimary": "预约商务沟通",
    "home.ctaSecondary": "查看产品",
    "home.productsEyebrow": "产品中心",
    "home.productsTitle": "三类产品服务，覆盖客服转化、内容运营与知识资产",
    ...
    "home.faq3Answer": "可以先从最影响转化和效率的问题开始判断：咨询和报价多就先看 AI 客服报价助手，内容素材要复用就看灵感方舟，话术和资料分散就看 AI 词库知识库。",
    ...
    "products.pageIntro": "围绕客户咨询、报价转化、内容素材管理和企业知识沉淀，构建可落地、可演示、可扩展的 AI 产品矩阵。",
  ...
  en: {
    ...
    "home.subtitle": "Vector Leap provides an AI service and quotation assistant, Inspiration Ark, and an AI lexicon knowledge base to help companies connect customers, content, and business workflows.",
    "home.ctaPrimary": "Book a Consultation",
    "home.ctaSecondary": "Explore Products",
    "home.productsEyebrow": "Products",
    "home.productsTitle": "Three product services for service conversion, content operations, and knowledge assets",
    ...
    "home.faq3Answer": "Start with the problem that affects conversion or efficiency most: inquiries and quotes for the service assistant, reusable content materials for Inspiration Ark, or scattered scripts and materials for the AI lexicon.",
    ...
    "products.pageIntro": "A deployable and scalable AI product matrix for customer inquiries, quotation conversion, content asset management, and enterprise knowledge assets.",
