const dictionary = {
  zh: {
    ...
    "nav.about": "关于我们",
    "nav.contact": "联系我们",
    "home.eyebrow": "海外电商增长 · AI 产品矩阵",
    "home.title": "以海外电商增长为主线，配套 AI 产品提升运营效率",
    "home.subtitle": "向量跃迁以海外电商增长项目为当前主营业务，并配套 AI 客服报价助手、灵感方舟与 AI 词库知识库，帮助企业打通选品、内容、客户承接与数据复盘。",
    "home.ctaPrimary": "预约商务沟通",
    "home.ctaSecondary": "查看产品",
    "home.productsEyebrow": "产品中心",
    "home.productsTitle": "主营业务优先展示海外电商增长，配套客服、内容与知识工具",
    "home.decisionEyebrow": "老板关心的不是 AI，是业务结果",
    "home.decisionTitle": "先把能不能落地、能不能转化、能不能长期用讲清楚",
    "home.decision1Title": "有没有真实入口",
    "home.decision1Text": "先看客户从哪里来：官网、微信、广告、短视频、展会、销售拜访或海外平台。只有接到真实入口，产品和服务才会变成业务资产。",
    "home.decision2Title": "有没有可衡量结果",
    "home.decision2Text": "我们优先关注响应速度、线索沉淀、报价效率、内容产出、知识复用和海外订单复盘这些能被团队感知的指标。",
    ...
    "home.value1": "从客户咨询、内容处理、知识资产沉淀到海外电商运营，围绕真实业务流程设计产品与服务。",
    ...
    "home.process1Text": "梳理客户来源、现有销售流程、内容运营方式、知识资料和海外电商目标市场，判断最适合先切入的场景。",
    ...
    "home.faq1Answer": "不需要一开始就准备完整资料。通常先提供产品介绍、常见客户问题、销售话术、商品资料、海外市场信息或视频素材，我们会先整理成可用的知识和流程结构。",
    ...
    "home.faq3Answer": "可以先从最影响转化和效率的问题开始判断：咨询和报价多就看 AI 客服报价助手，内容素材要复用就看灵感方舟，话术资料分散就看 AI 词库知识库，想试海外市场就看海外电商增长项目。",
    "home.faq4Question": "后续可以继续扩展吗？",
    "home.faq4Answer": "可以。我们会把首版做成可迭代的结构，后续可以继续接入更多知识库、客户入口、视频素材、报价规则、海外电商经营数据和业务模块。",
    "home.finalCtaTitle": "想了解 AI 或海外电商如何接入你的业务？",
    "home.finalCtaText": "留下需求，我们会根据你的行业、客户来源、业务流程和海外市场目标提供建议。",
    "home.finalCtaButton": "提交咨询",
    "home.officialEyebrow": "官方信息",
    "home.officialTitle": "这里是向量跃迁官方网站",
    "home.officialNameTitle": "品牌名称",
    "home.officialName": "向量跃迁 / Vector Leap",
    "home.officialDomainTitle": "官方域名",
    "home.officialContactTitle": "商务联系",
    "products.pageTitle": "以海外电商增长为核心，配套 AI 产品落地",
    "products.pageIntro": "海外电商增长是向量跃迁当前主营业务，我们围绕选品验证、店铺/独立站、内容获客、客服承接和数据复盘，配套 AI 客服、灵感方舟与 AI 词库知识库提升经营效率。",
    "products.fitEyebrow": "先做哪个业务",
    "products.fitTitle": "围绕主营业务搭建可复盘的增长闭环",
    ...
    "solutions.title": "先搭建海外电商增长闭环，再补齐 AI 效率工具",
    "solutions.intro": "解决方案以海外电商增长为主线，从选品、店铺/独立站、内容获客、客服承接和数据复盘出发，再判断哪些 AI 工具能提升转化与运营效率。",
    ...
    "solutions.ctaText": "告诉我们你现在的客户来源、销售流程、内容运营、知识资料或海外市场计划，向量跃迁会帮你判断优先落地路径。",
    "about.title": "让 AI 产品与出海增长走进企业经营现场",
    "about.intro": "向量跃迁专注企业 AI 产品化落地与海外电商增长服务，帮助企业把客户服务、内容增长、知识资产和出海经营变成可复制的数字能力。",
    ...
    "contact.intro": "告诉我们你的行业、产品、客户来源或海外市场目标，我们会判断哪类产品或服务最适合先落地。",
    "contact.name": "姓名",
    ...
    "contact.phone": "电话",
    "careers.title": "加入我们",
    "careers.text": "向量跃迁正在寻找对 AI 产品、企业服务、海外电商和行业数字化感兴趣的伙伴。如果你关注产品、技术、销售或内容增长，欢迎通过微信或邮箱联系我们。",
    "careers.cta": "联系加入",
    ...
    "footer.note": "官方网站 vectorleap.xyz · AI products and ecommerce growth.",
    "form.sending": "提交中...",
  ...
  en: {
    ...
    "nav.about": "About",
    "nav.contact": "Contact",
    "home.eyebrow": "Overseas E-commerce Growth · AI Product Matrix",
    "home.title": "Overseas E-commerce Growth First, Supported by AI Products",
    "home.subtitle": "Vector Leap's current core business is overseas e-commerce growth, supported by an AI service and quotation assistant, Inspiration Ark, and an AI lexicon knowledge base to connect product selection, content, customer service, and data review.",
    "home.ctaPrimary": "Book a Consultation",
    "home.ctaSecondary": "Explore Products",
    "home.productsEyebrow": "Products",
    "home.productsTitle": "Overseas e-commerce growth comes first, supported by service, content, and knowledge tools",
    ...
    "home.decision1Text": "We first look at where customers come from: website, WeChat, ads, short video, exhibitions, sales visits, or overseas platforms. Products and services become valuable when they connect to real entry points.",
    "home.decision2Title": "Measurable outcomes",
    "home.decision2Text": "We focus on response speed, lead capture, quotation efficiency, content output, knowledge reuse, and overseas order review: indicators your team can feel and improve.",
    ...
    "home.value1": "We design around real workflows, from customer inquiries, content processing, and knowledge assets to overseas e-commerce operations.",
    ...
    "home.process1Text": "Review customer sources, sales workflows, content operations, knowledge materials, and overseas market targets to choose the best first scenario.",
    ...
    "home.faq1Answer": "No. Product introductions, common customer questions, sales scripts, product data, overseas market information, or video materials are enough to start. We organize them into usable knowledge and workflow structures.",
    ...
    "home.faq3Answer": "Start with the problem that affects conversion or efficiency most: inquiries and quotes for the service assistant, reusable content for Inspiration Ark, scattered scripts for the AI lexicon, or overseas market testing for the e-commerce growth project.",
    "home.faq4Question": "Can it keep expanding later?",
    "home.faq4Answer": "Yes. The first version is built to iterate, with room for more knowledge bases, customer entry points, video assets, quotation rules, overseas e-commerce data, and business modules.",
    "home.finalCtaTitle": "Want to bring AI or overseas e-commerce into your workflow?",
    "home.finalCtaText": "Share your needs and we will recommend the right path for your industry, customer journey, and overseas market goals.",
    "home.finalCtaButton": "Submit Inquiry",
    "home.officialEyebrow": "Official Info",
    "home.officialTitle": "This is the official website of Vector Leap",
    "home.officialNameTitle": "Brand Name",
    "home.officialName": "Vector Leap / 向量跃迁",
    "home.officialDomainTitle": "Official Domain",
    "home.officialContactTitle": "Business Contact",
    "products.pageTitle": "Overseas e-commerce growth at the core, supported by AI products",
    "products.pageIntro": "Overseas e-commerce growth is Vector Leap's current core business. We focus on product validation, storefronts or independent sites, content acquisition, customer service, and data review, supported by AI service, Inspiration Ark, and the AI lexicon knowledge base.",
    "products.fitEyebrow": "Where to Start",
    "products.fitTitle": "Build a reviewable growth loop around the core business",
    ...
    "solutions.title": "Build the overseas e-commerce growth loop first, then add AI efficiency tools",
    "solutions.intro": "Solutions are centered on overseas e-commerce growth, from product selection, storefronts or independent sites, content acquisition, customer service, and data review, then mapping the AI tools that improve conversion and operations.",
    ...
    "solutions.ctaText": "Tell us about your customer sources, sales workflow, content operations, knowledge materials, or overseas market plan. Vector Leap will help you choose the first implementation path.",
    "about.title": "Bring AI products and global growth into business operations",
    "about.intro": "Vector Leap focuses on productized AI implementation and overseas e-commerce growth, helping companies turn customer service, content growth, knowledge assets, and global operations into reusable digital capabilities.",
    ...
    "contact.intro": "Tell us your industry, products, customer sources, or overseas market goals. We will recommend the best product or service to start with.",
    "contact.name": "Name",
    ...
    "careers.text": "Vector Leap is looking for people interested in AI products, enterprise services, overseas e-commerce, and industry digitalization. If you care about product, engineering, sales, or content growth, contact us via WeChat or email.",
    ...
    "footer.note": "Official domain vectorleap.xyz · AI products and ecommerce growth.",
